...
async function pushTrialExpiringTemplate() {
  console.log('Pushing AURUM_TRIAL_EXPIRING automation template to Brevo...');
  
  try {
    const htmlContent = fs.readFileSync('src/templates/emails/trial_expiring.html', 'utf8');
